...
Software version:
		...
		GATK		version 2.7-4			bundle
		annovar		version 2013-08-21		humandb
DATABASE version:
		refGene(RefSeq)		hg19,2013feb11	ANNOVAR
		ensGene(Ensembl)	hg19,2013feb11	ANNOVAR
		knownGene(UCSC)		hg19,2013feb11	ANNOVAR
		ccdsGene			hg19			ANNOVAR
		SIFT				hg19			BGI
		COSMIC				hg19,20130706	ANNOVAR
		ESP					hg19,2013jan22	ANNOVAR
		DBSNP				hg19,dbsnp137	UCSC
Description:
...
#ANNOTATION#########
####################
system("bash $script/pipe_annotation.sh $outdir $finalSNP $finalINDEL $pe1 $pe2 $reference");
