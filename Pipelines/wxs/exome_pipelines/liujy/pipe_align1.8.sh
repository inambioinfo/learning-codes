...
perl bam2pileup.pl -b $ALN_OUTFILE/$SAMFILE.sai.sam.bam
...
perl bam2pileup.pl -b $ALN_OUTFILE/$SAMFILE.sai.sam.dedup.bam

#COMPUTE DATA STATISTICS
perl summary_Roche_Read_Length_100.pl_2.0 -pe1 $SAMPLE_FILE/$SAMPLE1 -pe2 $SAMPLE_FILE/$SAMPLE2 -o $ALN_OUTFILE/$SAMFILE.xls 
