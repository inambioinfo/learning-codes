...
my $chipCap = '/project/liucj/REFDATA/target_region/Illumina/TruSeq-Exome-Targeted-Regions-BED-file_62M'; #chip beta
my $readLength; 								#read length of fastq file 
my $targetRegionIllumina = "62085286"; 						#total bps in NimbleGem chip
