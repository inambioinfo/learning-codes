...
my $chipCap = '/project/liucj/REFDATA/target_region/Agilent/SureSelect_All_Exon_50mb_with_annotation_hg19_bed_50M'; #chip beta
my $readLength; 								#read length of fastq file 
my $targetRegionIllumina = "51646629"; 						#total bps in NimbleGem chip
