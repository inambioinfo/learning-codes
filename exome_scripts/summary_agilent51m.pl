...
use Getopt::Long;
use File::Basename;
#Sun Aug 31 16:50:36 CST 2014
#AUTHOR: C.J. LIU
#AIM: SUMMARY OF THE DATA QUALITY;


my $chipCap = '/project/liucj/REFDATA/target_region/Agilent/SureSelect_All_Exon_51mb_with_annotation_hg19_bed_51M'; #chip beta
my $readLength; 								#read length of fastq file 
my $targetRegionIllumina = "51391525"; 						#total bps in NimbleGem chip
...
Description:
	...
	The version of chip is 'SureSelect_All_Exon_51mb_with_annotation_hg19_bed_51M'
Usage:
